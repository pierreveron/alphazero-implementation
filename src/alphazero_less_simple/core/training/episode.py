...
class Sample:
    ...
    state: np.ndarray
    policy: np.ndarray  # Maps actions to their MCTS visit probabilities
    value: float  # The actual game outcome from this state
...
class Episode:
    ...
    def backpropagate_outcome(self, value: float) -> None:
